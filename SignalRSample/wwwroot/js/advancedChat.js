...
connection.on("ReceivePrivateMessage", function (senderId, senderName, receiveId, receiverName, message, chatId) {
    receiveprivateMessage(senderId, senderName, receiveId, receiverName, message, chatId);
});
